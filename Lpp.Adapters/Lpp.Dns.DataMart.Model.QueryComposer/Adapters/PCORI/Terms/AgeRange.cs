...
namespace Lpp.Dns.DataMart.Model.QueryComposer.Adapters.PCORI.Terms {
    ...
    public class AgeRange : TermImplementation, ITermResultTransformer {
        ...
        private Expression BuildCalculationDateExpression(ParameterExpression pe_sourceQueryType, Expression bornOnExpression, Expression bornOnMonthExpression) {
        ...
        private Expression BuildEncounterCriteriaExpression(ParameterExpression pe_sourceQueryType, DTO.QueryComposer.QueryComposerCriteriaDTO primaryCriteria, DTO.Enums.AgeRangeCalculationType calculationType, Expression bornOnExpression, Expression bornOnMonthExpression) {
            Expression encountersProp = Expressions.AsQueryable(Expression.Property(pe_sourceQueryType, "Encounters"));
...
#pragma warning restore CS0162
        ...
        private readonly Model.Settings.SQLProvider _sqlProvider;
    }
}