...
namespace Lpp.Dns.DataMart.Model.QueryComposer.Adapters.PCORI {
    ...
    public class PCORIModelAdapter : DynamicModelAdapter<pcori.Patient> {
        ...
        /// <returns></returns>
        protected override Expression<Func<pcori.Patient, bool>> MergeParagraphPredicates(Expression<Func<pcori.Patient, bool>> queryPredicate,
            Expression<Func<pcori.Patient, bool>> nextParagraphPredicate,
            DTO.Enums.QueryComposerOperators conjunction, bool isExclusion) {
        ...
        private static IEnumerable<string> TranslateSex(object raw) {
        ...
        private Expression<Func<pcori.Patient, bool>> ApplyAgeRangeTerms(QueryComposerCriteriaDTO paragraph, Expression<Func<pcori.Patient, bool>> patientPredicate) {
        ...
        private Expression<Func<pcori.Patient, bool>> ApplyCombinedDiagnosisCodeTerms(QueryComposerCriteriaDTO paragraph, Expression<Func<pcori.Patient, bool>> patientPredicate) {
        ...
        private Expression<Func<pcori.Patient, bool>> ApplyProcedureCodeTerms(QueryComposerCriteriaDTO paragraph, Expression<Func<pcori.Patient, bool>> patientPredicate) {
            //the terms could exist in the main terms collection or in the subcriteria holding multiple combined diagnosis terms
        ...
        private Expression<Func<pcori.Patient, bool>> ApplySexTerms(QueryComposerCriteriaDTO paragraph, Expression<Func<pcori.Patient, bool>> patientPredicate) {
        ...
        private Expression<Func<pcori.Patient, bool>> ApplyVisitsTerms(QueryComposerCriteriaDTO paragraph, Expression<Func<pcori.Patient, bool>> patientPredicate) {
        ...
        private Expression<Func<pcori.Patient, bool>> ApplyVitalsTerms(QueryComposerCriteriaDTO paragraph, Expression<Func<pcori.Patient, bool>> patientPredicate) {
        ...
        private IEnumerable<Objects.Dynamic.IPropertyDefinition> VisitPropertyDefinitionsForTransforms(IEnumerable<ITermResultTransformer> resultTransformers, IEnumerable<Objects.Dynamic.IPropertyDefinition> propertyDefinitions) {
        ...
        private QueryComposerRequestInterrogator _queryInterrogator = null;
        private Model.Settings.SQLProvider _sqlProvider = Settings.SQLProvider.SQLServer;
