...
//    public static class XDataSetConnection {
//        /// <summary>
...
// //var section = (DataSetConnectionSection) ConfigurationManager.GetSection(DataSetConnectionSection.SectionName); IRegistry registry = new
// AppConfigRegistry(); var dataSetConnectionElementMap = registry.GetDataSetConnectionElementMap();

// var dataSetConnectionElement = dataSetConnectionElementMap[name];

// switch (dataSetConnectionElement.ConnectionType) { case DataSetConnectionElement.ConnectionTypeEnum.HTTP: { connection = new
// HttpDataSetConnection(dataSetConnectionElement); break; } case DataSetConnectionElement.ConnectionTypeEnum.Database: { connection = new
// DatabaseDataSetConnection(dataSetConnectionElement); break; }
