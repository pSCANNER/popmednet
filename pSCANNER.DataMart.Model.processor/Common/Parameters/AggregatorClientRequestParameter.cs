...
namespace Lpp.Scanner.DataMart.Model.Processors.Common.Parameters {
    ...
    public class AggregatorClientRequestParameter : BaseProxyRequestParameter, IRExecution {
        ...
        public AggregatorClientRequestParameter(string requestId, string dataSetJson, string parametersJson, string pmmlJson, BaseDataSetConnection dataSetConnection, string executionPath) : base(requestId, dataSetJson, parametersJson, pmmlJson, dataSetConnection, RequestForEnum.PostRequest) {
