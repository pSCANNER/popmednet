...
namespace Lpp.Scanner.DataMart.Model.Processors.Common.Pmml {
    ...
    public class PmmlDocument {
        ...
        /// </summary>
        /// <returns></returns>
        public PmmlRequestParameterList GetRequestParameterList() {
            var elementsByTagName = TheXmlDocument.GetElementsByTagName(Constants.Pmml.Tags.PMML.GeneralRegressionModel.RequestParameterListConst.TagName);
            return new PmmlRequestParameterList(elementsByTagName);
        }
    }
}